...
patternName = '^[A-ZА-Я]{1}[a-zа-я]+\s+[A-ZА-Я]{1}[a-zа-я]+$'
print("true" if re.match(patternName, name) else "false")

patternEmail = '^[a-z_0-9]+@[a-z0-9\.]+\.(ru|org|com)$'
print("true" if re.match(patternEmail, email) else "false")
...
patternStr = '\.{2,}'
print("true" if re.findall(patternStr, some_str) else "false")